...
import { RANKING_PATH } from "@/features/ranking/ranking-href";
...
export const metadata: Metadata = {
  title: "Ranking",
  description: "Ranking geral do torneio dos alunos — CT Beach Sports 2026",
};
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <CategoryTabs active={categoria} nivel={level} basePath={RANKING_PATH} q={q} />
        <LevelTabs active={level} categoria={categoria} basePath={RANKING_PATH} q={q} />
      </div>
